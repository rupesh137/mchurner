         ...
         <div class="productLoan">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
							<img src="images/goldLoan.png" class="img-responsive LFloat"/>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-10 col-lg-10">
							...
							<div class="readBtn">
								<a href="gold_loan.html">Read More</a>
							</div>
						</div>										
					</div>					
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-10 col-lg-10">
							...
							<div class="readBtn">
								<a href="mortgage _loan.html">Read More</a>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
							<img src="images/mortgageLoan.png" class="img-responsive LFloat"/>
						</div>
					</div>					
				</div>
			</div>
			...
			<div class="bgSection">
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
							<img src="images/policyLoan.png" class="img-responsive LFloat"/>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-10 col-lg-10">
							...
							<div class="readBtn">
								<a href="Loan_against_LIC_Policy.html">Read More</a>
							</div>
						</div>										
					</div>					
				</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-10 col-lg-10">
							...
							<div class="readBtn">
								<a href="vehicle_loan.html">Read More</a>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
							<img src="images/vehicleLoan.png" class="img-responsive LFloat"/>
						</div>
					</div>					
				</div>
			</div>
